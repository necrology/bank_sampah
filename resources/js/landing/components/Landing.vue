            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item mx-0 mx-lg-1">
                        <a href="http://localhost:8000/login" class="nav-link py-3 px-0 px-lg-3 rounded">Login</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 me-auto">
                    <p class="lead">
                        ...
                        change the icon in the dividers, and add your email
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <p class="mb-4">
                                    ...
                                    adipisicing elit. Mollitia neque assumenda
                                    ipsam nihil, molestias magnam, recusandae
